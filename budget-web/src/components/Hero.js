    ...
    return (
        <>
            ...
            <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
                ...
                <h1 class="mt-10 text-4xl font-bold tracking-tight text-white sm:text-6xl">YOUR GATEWAY TO THE WORLD OF KNOWLEDGE</h1>
                <p class="mt-6 text-lg leading-8 text-gray-300">Explore the depths of scientific and research work and stay informed of the latest developments in knowledge..</p>
                <div class="mt-10 flex items-center gap-x-6">
                    <a href="/" class="rounded-md bg-blue-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400">Get started</a>
