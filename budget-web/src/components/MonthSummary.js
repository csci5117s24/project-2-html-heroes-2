    ...
    return (
        ...
        <a href="#" class="my-3 block p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 white:bg-gray-800 white:border-gray-700 white:hover:bg-gray-700">
            <div className="flow-root">
                <h5 class="float-left mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-dark">April Budget</h5>
                <button class="float-right px-2 py-1 text-sm font-semibold text-gray-900 border border-gray-500 rounded-full">Edit</button>
            </div>
            <p class="font-normal text-gray-600 dark:text-gray-700">$345.65 left in the month</p>
            <div className="grid grid-cols-1 md:grid-cols-2 place-items-center mt-4">
                ...
                <div>
                    ...
                    <div class="my-3 flex items-center justify-between">
                        <p class="text-gray-700 text-xl dark:text-gray-700">Spent so Far: &nbsp;</p>
                        <p class="text-gray-900 text-xl dark:text-dark">$345.65</p>
                    </div>
                    <div class="my-3 flex items-center justify-between">
                        <p class="text-gray-700 text-xl dark:text-gray-700">Remaining Amount: &nbsp;</p>
                        <p class="text-gray-900 text-xl dark:text-dark">$345.65</p>
                    </div>
                    <div class="my-3 flex items-center justify-between">
                        <p class="text-gray-700 text-xl dark:text-gray-700">Budget: &nbsp;</p>
                        <p class="text-gray-900 text-xl dark:text-dark">$2000</p>
                    </div>
                    {/* https://tailwindcomponents.com/component/cookie-banner-with-action-buttons */}
                    <div class="max-w-2xl p-4 mx-auto bg-white border border-gray-200 md:gap-x-4 white:bg-gray-900 md:flex md:items-center dark:border-gray-700 rounded-2xl">
                        <div class="flex items-center gap-x-4">
                            <span class="inline-flex p-2 text-yellow-500 rounded-lg shrink-0 white:bg-gray-800 bg-yellow-100/80">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-700">Looking good! You're on track with your budget!</p>
                        </div>
