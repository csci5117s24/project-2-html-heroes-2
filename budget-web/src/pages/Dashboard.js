        ...
        <div>
            <header class="bg-white shadow">
                <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 flow-root">
                    <h1 class="float-left text-3xl font-bold tracking-tight text-gray-900">Dashboard</h1>
                    <div>
                        {/* https://tailwindcomponents.com/component/tailwind-css-bouton-hover-effect */}
                        <button class="float-right btn overflow-hidden relative w-auto bg-blue-500 text-sm text-white py-3 px-4 rounded-xl font-bold uppercase -- before:block before:absolute before:h-full before:w-1/2 before:rounded-full before:bg-blue-100 before:top-0 before:left-1/4 before:transition-transform before:opacity-0 before:hover:opacity-100 hover:text-white-200 hover:before:animate-ping transition-all duration-300">
                            <span class="relative">Add Transaction</span>
                        </button>
                    </div>
                </div>
            </header>
